...
public class PontoControlViewState {
	...
	private long usrExp;
	private final ConfiguracoesUsuario configuracaoUsuario;
	...
	public PontoControlViewState(ConfiguracoesUsuario configuracaoUsuario) {
	...
	public String getTotalAlmoco() {
		if (totalAlmoco != null) {
			return String.format("%s (%.3f)", TimeUtils.fromLocalTime(totalAlmoco, TIME_PATTERN), (TimeUtils.toNumberLocalTime(totalAlmoco, configuracaoUsuario.getAlmoco())));
		}
		return "-";
	}
	...
	public boolean extrairParaXLS(String path) {
		carregarFolhaMensal();
		return exportadorController.extrair(folhaMensal, path);
	}
	...
	public void setInterfaceMensagemInformativa(Mensagem mensagem) {
		interfaceMensagemInformativa = mensagem;
	}

	public void setInterfaceMensagemConfirmacao(Mensagem mensagem) {
		interfaceMensagemConfirmacao = mensagem;
	}
