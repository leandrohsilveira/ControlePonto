 ...
 * @author Leandro
 */
public class FolhaPontoController implements IFolhaPontoController {
   ...
   public FolhaMensalPontoJSON recuperarFolhaMensal() {
      return recuperarFolhaMensal(DateUtils.getActualYear(), DateUtils.getActualMonth());
   }
   ...
   public RegistroDiarioPontoJSON recuperarRegistroDiario(FolhaMensalPontoJSON folhaMensal) {
      return recuperarRegistroDiario(DateUtils.getActualDayOfMonth(), folhaMensal);
   }
